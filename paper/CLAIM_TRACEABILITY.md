...
| C9 | Recentering the decision statistic on the empirical null lowers the cMDE ~tenfold and restores size **at the declared window `W=120`**. The repaired `q=2` record is `superseded_exploratory`, not a protocol-v5 admission. A confirmatory successor with `alpha_0=0.025` and unseen 2026-06/07 BTC data replaces it. | exploratory / superseded | `recentered_reference_repair_20260710.json`; successor specified in `prereg/PREREGISTRATION-v5.0-amendment.md`. |
...
| C13 | The EUR/USD rolling-quantile certificate is the second asset-class/detector-family certificate. Development 2021-05-30..2025-12-31; unseen evaluation 2026-01-01..2026-07-31. The HistData cost-gate summary remains a matched-span sample, not the certificate. | pending complete certificate | protocol v5 §5; existing `eurusd_histdata_cost_gate_matched_...summary.json` is not the certificate. |
